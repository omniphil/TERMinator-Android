...
"class CRYPT_OBJECT_INFO:\n\
    ...
    Py_DECREF(v); /* RC4 (insecure, disabled by default) */
    ...
    v = Py_BuildValue("i", CRYPT_ALGO_CHACHA20);
    PyDict_SetItemString(moduleDict, "CRYPT_ALGO_CHACHA20", v);
    Py_DECREF(v); /* ChaCha20 */
    ...
    Py_DECREF(v); /* MD5 (only used internally for TLS 1.0/1.1) */
    ...
    v = Py_BuildValue("i", CRYPT_ALGO_RESERVED7);
    PyDict_SetItemString(moduleDict, "CRYPT_ALGO_RESERVED7", v);
    ...
    Py_DECREF(v); /* HMAC-SHA-nextgen */

    v = Py_BuildValue("i", CRYPT_ALGO_POLY1305);
    PyDict_SetItemString(moduleDict, "CRYPT_ALGO_POLY1305", v);
    Py_DECREF(v); /* Poly1305 */
    ...
    v = Py_BuildValue("i", CRYPT_PKCFORMAT_NONE);
    PyDict_SetItemString(moduleDict, "CRYPT_PKCFORMAT_NONE", v);
    Py_DECREF(v); /* No PKC format type */

    v = Py_BuildValue("i", CRYPT_PKCFORMAT_PKCS1);
    PyDict_SetItemString(moduleDict, "CRYPT_PKCFORMAT_PKCS1", v);
    Py_DECREF(v); /* PKCS #1 */

    v = Py_BuildValue("i", CRYPT_PKCFORMAT_DEFAULT);
    PyDict_SetItemString(moduleDict, "CRYPT_PKCFORMAT_DEFAULT", v);
    Py_DECREF(v);

    v = Py_BuildValue("i", CRYPT_PKCFORMAT_OAEP);
    PyDict_SetItemString(moduleDict, "CRYPT_PKCFORMAT_OAEP", v);
    Py_DECREF(v); /* RSA-OAEP */

    v = Py_BuildValue("i", CRYPT_PKCFORMAT_PSS);
    PyDict_SetItemString(moduleDict, "CRYPT_PKCFORMAT_PSS", v);
    Py_DECREF(v); /* RSA-PSS */

    v = Py_BuildValue("i", CRYPT_PKCFORMAT_LAST);
    PyDict_SetItemString(moduleDict, "CRYPT_PKCFORMAT_LAST", v);
    Py_DECREF(v); /* Last possible PKC format type */
    ...
    v = Py_BuildValue("i", CRYPT_DEVICE_TPM);
    PyDict_SetItemString(moduleDict, "CRYPT_DEVICE_TPM", v);
    Py_DECREF(v); /* TPM, formerly Fortezza */
    ...
    v = Py_BuildValue("i", CRYPT_SESSION_SCVP);
    PyDict_SetItemString(moduleDict, "CRYPT_SESSION_SCVP", v);
    Py_DECREF(v); /* SCVP */

    v = Py_BuildValue("i", CRYPT_SESSION_SCVP_SERVER);
    PyDict_SetItemString(moduleDict, "CRYPT_SESSION_SCVP_SERVER", v);
    Py_DECREF(v); /* SCVP server */
    ...
    Py_DECREF(v); /* Conventional encryption algorithm */
    ...
    v = Py_BuildValue("i", CRYPT_OPTION_PKC_FORMAT);
    PyDict_SetItemString(moduleDict, "CRYPT_OPTION_PKC_FORMAT", v);
    Py_DECREF(v); /* PKC format */

    v = Py_BuildValue("i", CRYPT_OPTION_ENCR_HASHPARAM);
    PyDict_SetItemString(moduleDict, "CRYPT_OPTION_ENCR_HASHPARAM", v);
    Py_DECREF(v); /* Hash/MAC parameter */
    ...
    Py_DECREF(v); /* 2 5 29 14 subjectKeyIdentifier */
    ...
    v = Py_BuildValue("i", CRYPT_CERTINFO_CMS_ALGORITHMPROTECTION);
    PyDict_SetItemString(moduleDict, "CRYPT_CERTINFO_CMS_ALGORITHMPROTECTION", v);
    Py_DECREF(v);

    v = Py_BuildValue("i", CRYPT_CERTINFO_CMS_ALGORITHMPROTECTION_HASH);
    PyDict_SetItemString(moduleDict, "CRYPT_CERTINFO_CMS_ALGORITHMPROTECTION_HASH", v);
    Py_DECREF(v); /* Signer hash algorithm */

    v = Py_BuildValue("i", CRYPT_CERTINFO_CMS_ALGORITHMPROTECTION_SIG);
    PyDict_SetItemString(moduleDict, "CRYPT_CERTINFO_CMS_ALGORITHMPROTECTION_SIG", v);
    Py_DECREF(v); /* Signer sig.algorithm */

    v = Py_BuildValue("i", CRYPT_CERTINFO_CMS_ALGORITHMPROTECTION_MAC);
    PyDict_SetItemString(moduleDict, "CRYPT_CERTINFO_CMS_ALGORITHMPROTECTION_MAC", v);
    Py_DECREF(v); /* Signer MAC algorithm */
    ...
    v = Py_BuildValue("i", CRYPT_SESSINFO_AUTHTOKEN);
    PyDict_SetItemString(moduleDict, "CRYPT_SESSINFO_AUTHTOKEN", v);
    Py_DECREF(v); /* Authentication token, e.g. TOTP */
    ...
    v = Py_BuildValue("i", CRYPT_SESSINFO_CMP_OPTIONS);
    PyDict_SetItemString(moduleDict, "CRYPT_SESSINFO_CMP_OPTIONS", v);
    Py_DECREF(v); /* CMP protocol options */
    ...
    v = Py_BuildValue("i", CRYPT_SESSINFO_SSH_PREAUTH);
    PyDict_SetItemString(moduleDict, "CRYPT_SESSINFO_SSH_PREAUTH", v);
    Py_DECREF(v); /* SSH pre-authentication value */

    v = Py_BuildValue("i", CRYPT_SESSINFO_TLS_OPTIONS);
    PyDict_SetItemString(moduleDict, "CRYPT_SESSINFO_TLS_OPTIONS", v);
    ...
    v = Py_BuildValue("i", CRYPT_SESSINFO_TLS_SUBPROTOCOL);
    PyDict_SetItemString(moduleDict, "CRYPT_SESSINFO_TLS_SUBPROTOCOL", v);
    Py_DECREF(v); /* SSL/TLS additional sub-protocol */

    v = Py_BuildValue("i", CRYPT_SESSINFO_TLS_WSPROTOCOL);
    PyDict_SetItemString(moduleDict, "CRYPT_SESSINFO_TLS_WSPROTOCOL", v);
    Py_DECREF(v); /* SSL/TLS WebSockets sub-protocol */

    v = Py_BuildValue("i", CRYPT_SESSINFO_TLS_EAPCHALLENGE);
    PyDict_SetItemString(moduleDict, "CRYPT_SESSINFO_TLS_EAPCHALLENGE", v);
    Py_DECREF(v); /* TLS EAP challenge */

    v = Py_BuildValue("i", CRYPT_SESSINFO_TLS_EAPKEY);
    PyDict_SetItemString(moduleDict, "CRYPT_SESSINFO_TLS_EAPKEY", v);
    Py_DECREF(v); /* TLS EAP key */

    v = Py_BuildValue("i", CRYPT_SESSINFO_TLS_EAPDATA);
    PyDict_SetItemString(moduleDict, "CRYPT_SESSINFO_TLS_EAPDATA", v);
    Py_DECREF(v); /* TLS EAP additional data */
    ...
    v = Py_BuildValue("i", CRYPT_CONTENT_SCVPCERTVALREQUEST);
    PyDict_SetItemString(moduleDict, "CRYPT_CONTENT_SCVPCERTVALREQUEST", v);
    Py_DECREF(v);

    v = Py_BuildValue("i", CRYPT_CONTENT_SCVPCERTVALRESPONSE);
    PyDict_SetItemString(moduleDict, "CRYPT_CONTENT_SCVPCERTVALRESPONSE", v);
    Py_DECREF(v);

    v = Py_BuildValue("i", CRYPT_CONTENT_SCVPVALPOLREQUEST);
    PyDict_SetItemString(moduleDict, "CRYPT_CONTENT_SCVPVALPOLREQUEST", v);
    Py_DECREF(v);

    v = Py_BuildValue("i", CRYPT_CONTENT_SCVPVALPOLRESPONSE);
    PyDict_SetItemString(moduleDict, "CRYPT_CONTENT_SCVPVALPOLRESPONSE", v);
    Py_DECREF(v);
    ...
    v = Py_BuildValue("i", CRYPT_SUBPROTOCOL_PEAP);
    PyDict_SetItemString(moduleDict, "CRYPT_SUBPROTOCOL_PEAP", v);
    Py_DECREF(v); /* PEAP */
    ...
    v = Py_BuildValue("i", CRYPT_ECCCURVE_25519);
    PyDict_SetItemString(moduleDict, "CRYPT_ECCCURVE_25519", v);
    Py_DECREF(v); /* X25519/Ed25519 */

    v = Py_BuildValue("i", CRYPT_ECCCURVE_448);
    PyDict_SetItemString(moduleDict, "CRYPT_ECCCURVE_448", v);
    Py_DECREF(v); /* X448/Ed448 */
    ...
    v = Py_BuildValue("i", CRYPT_CMPOPTION_NONE);
    PyDict_SetItemString(moduleDict, "CRYPT_CMPOPTION_NONE", v);
    Py_DECREF(v);

    v = Py_BuildValue("i", CRYPT_CMPOPTION_3GPP);
    PyDict_SetItemString(moduleDict, "CRYPT_CMPOPTION_3GPP", v);
    Py_DECREF(v); /* Peer is following 33.310 */

    v = Py_BuildValue("i", CRYPT_TLSOPTION_NONE);
    PyDict_SetItemString(moduleDict, "CRYPT_TLSOPTION_NONE", v);
    Py_DECREF(v);

    v = Py_BuildValue("i", CRYPT_TLSOPTION_MINVER_SSLV3);
    PyDict_SetItemString(moduleDict, "CRYPT_TLSOPTION_MINVER_SSLV3", v);
    Py_DECREF(v); /* Min.protocol version */

    v = Py_BuildValue("i", CRYPT_TLSOPTION_MINVER_TLS10);
    PyDict_SetItemString(moduleDict, "CRYPT_TLSOPTION_MINVER_TLS10", v);
    Py_DECREF(v);

    v = Py_BuildValue("i", CRYPT_TLSOPTION_MINVER_TLS11);
    PyDict_SetItemString(moduleDict, "CRYPT_TLSOPTION_MINVER_TLS11", v);
    Py_DECREF(v);

    v = Py_BuildValue("i", CRYPT_TLSOPTION_MINVER_TLS12);
    PyDict_SetItemString(moduleDict, "CRYPT_TLSOPTION_MINVER_TLS12", v);
    Py_DECREF(v);

    v = Py_BuildValue("i", CRYPT_TLSOPTION_MINVER_TLS13);
    PyDict_SetItemString(moduleDict, "CRYPT_TLSOPTION_MINVER_TLS13", v);
    Py_DECREF(v);

    v = Py_BuildValue("i", CRYPT_TLSOPTION_MANUAL_CERTCHECK);
    PyDict_SetItemString(moduleDict, "CRYPT_TLSOPTION_MANUAL_CERTCHECK", v);
    Py_DECREF(v); /* Require manual cert.verif. */

    v = Py_BuildValue("i", CRYPT_TLSOPTION_DISABLE_NAMEVERIFY);
    PyDict_SetItemString(moduleDict, "CRYPT_TLSOPTION_DISABLE_NAMEVERIFY", v);
    Py_DECREF(v); /* Disable cert hostname check */

    v = Py_BuildValue("i", CRYPT_TLSOPTION_DISABLE_CERTVERIFY);
    PyDict_SetItemString(moduleDict, "CRYPT_TLSOPTION_DISABLE_CERTVERIFY", v);
    ...
    Py_DECREF(v); /* SuiteB security levels (will */

    v = Py_BuildValue("i", CRYPT_TLSOPTION_SUITEB_256);
    PyDict_SetItemString(moduleDict, "CRYPT_TLSOPTION_SUITEB_256", v);
