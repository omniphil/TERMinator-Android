...
/* Device ACL macros */
  ...
  #define MKPERM_HARDWARE( perm )		ACCESS_##perm
  #define MKPERM_INT_HARDWARE( perm )	ACCESS_INT_##perm
#else
  #define MKPERM_HARDWARE( perm )		ACCESS_xxx_xxx
  #define MKPERM_INT_HARDWARE( perm )	ACCESS_INT_xxx_xxx
#endif /* USE_HARDWARE */
...
#ifdef USE_TLS
  #define MKPERM_TLS( perm )			ACCESS_##perm
  #define MKPERM_INT_TLS( perm )		ACCESS_INT_##perm
#else
  #define MKPERM_TLS( perm )			ACCESS_xxx_xxx
  #define MKPERM_INT_TLS( perm )		ACCESS_INT_xxx_xxx
#endif /* USE_TLS */

#ifdef USE_EAP
  #define MKPERM_TLS_EAP( perm )		ACCESS_##perm
  #define MKPERM_INT_TLS_EAP( perm )	ACCESS_INT_##perm
#else
  #define MKPERM_TLS_EAP( perm )		ACCESS_xxx_xxx
  #define MKPERM_INT_TLS_EAP( perm )	ACCESS_INT_xxx_xxx
#endif /* USE_EAP */

#ifdef USE_WEBSOCKETS
  #define MKPERM_TLS_WS( perm )			ACCESS_##perm
  #define MKPERM_INT_TLS_WS( perm )		ACCESS_INT_##perm
#else
  #define MKPERM_TLS_WS( perm )			ACCESS_xxx_xxx
  #define MKPERM_INT_TLS_WS( perm )		ACCESS_INT_xxx_xxx
#endif /* USE_WEBSOCKETS */

#if defined( USE_WEBSOCKETS ) || defined( USE_EAP )
  #define MKPERM_TLS_EAPWS( perm )		ACCESS_##perm
  #define MKPERM_INT_TLS_EAPWS( perm )	ACCESS_INT_##perm
#else
  #define MKPERM_TLS_EAPWS( perm )		ACCESS_xxx_xxx
  #define MKPERM_INT_TLS_EAPWS( perm )	ACCESS_INT_xxx_xxx
...
#ifdef USE_TPM
  #define MKTYPE_TPM( type )			type 
#else
  #define MKTYPE_TPM( type )			0
#endif /* USE_TPM */

#ifdef USE_HARDWARE
  #define MKTYPE_HW( type )				type 
#else
  #define MKTYPE_HW( type )				0
#endif /* USE_HARDWARE */
...
#ifdef USE_TLS
  #define MKTYPE_TLS( type )			type 
#else
  #define MKTYPE_TLS( type )			0
#endif /* USE_TLS */
