...
void chacha_keysetup(chacha_ctx *ctx, const uint8_t *k)	/* pcg */
{
...
static int
stream_ietf_ext_ref(unsigned char *c, unsigned long clen,
...
stream_ref_xor_ic(unsigned char *c, const unsigned char *m,
                  unsigned long mlen, const unsigned char *n, uint64_t ic,
                  const unsigned char *k)
{
    struct chacha_ctx ctx;
    uint8_t           ic_bytes[8];
