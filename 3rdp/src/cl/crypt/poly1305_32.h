                ...
                unsigned long bytes)
{
    ...
    unsigned LONGLONG_TYPE  d0, d1, d2, d3, d4;
    unsigned long       c;
    ...
    while (bytes >= poly1305_block_size) {
        ...
        /* h *= r */
        d0 = ((unsigned LONGLONG_TYPE) h0 * r0) + ((unsigned LONGLONG_TYPE) h1 * s4) +
             ((unsigned LONGLONG_TYPE) h2 * s3) + ((unsigned LONGLONG_TYPE) h3 * s2) +
             ((unsigned LONGLONG_TYPE) h4 * s1);
        d1 = ((unsigned LONGLONG_TYPE) h0 * r1) + ((unsigned LONGLONG_TYPE) h1 * r0) +
             ((unsigned LONGLONG_TYPE) h2 * s4) + ((unsigned LONGLONG_TYPE) h3 * s3) +
             ((unsigned LONGLONG_TYPE) h4 * s2);
        d2 = ((unsigned LONGLONG_TYPE) h0 * r2) + ((unsigned LONGLONG_TYPE) h1 * r1) +
             ((unsigned LONGLONG_TYPE) h2 * r0) + ((unsigned LONGLONG_TYPE) h3 * s4) +
             ((unsigned LONGLONG_TYPE) h4 * s3);
        d3 = ((unsigned LONGLONG_TYPE) h0 * r3) + ((unsigned LONGLONG_TYPE) h1 * r2) +
             ((unsigned LONGLONG_TYPE) h2 * r1) + ((unsigned LONGLONG_TYPE) h3 * r0) +
             ((unsigned LONGLONG_TYPE) h4 * s4);
        d4 = ((unsigned LONGLONG_TYPE) h0 * r4) + ((unsigned LONGLONG_TYPE) h1 * r3) +
             ((unsigned LONGLONG_TYPE) h2 * r2) + ((unsigned LONGLONG_TYPE) h3 * r1) +
             ((unsigned LONGLONG_TYPE) h4 * r0);
...
poly1305_finish(poly1305_state_internal_t *st, unsigned char mac[16])
{
    ...
    unsigned LONGLONG_TYPE f;
    unsigned long      mask;

    /* process the remaining block */
    if (st->leftover) {
        unsigned LONGLONG_TYPE i = st->leftover;
    ...
    /* mac = (h + pad) % (2^128) */
    f  = (unsigned LONGLONG_TYPE) h0 + st->pad[0];
    h0 = (unsigned long) f;
    f  = (unsigned LONGLONG_TYPE) h1 + st->pad[1] + (f >> 32);
    h1 = (unsigned long) f;
    f  = (unsigned LONGLONG_TYPE) h2 + st->pad[2] + (f >> 32);
    h2 = (unsigned long) f;
    f  = (unsigned LONGLONG_TYPE) h3 + st->pad[3] + (f >> 32);
    h3 = (unsigned long) f;
